...
class Kushki_WC {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Kushki_Loader $loader Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Kushki_Loader. Orchestrates the hooks of the plugin.
	 * - Kushki_i18n. Defines internationalization functionality.
	 * - Kushki_Admin. Defines all hooks for the admin area.
	 * - Kushki_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once dirname( dirname( __FILE__ ) ) . '/includes/class-kushki-i18n.php';
	 ...
	 *
	 * Uses the Kushki_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
